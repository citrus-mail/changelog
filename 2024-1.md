...
### 07/02/2025
- You can now import your contacts from your IMAP account.
- You can take action on specific message in a thread, not the last one only.
...
- Quick action bar when you hover on a message in the list.
